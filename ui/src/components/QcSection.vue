...
import type { QcCheckResult } from "@platforma-open/milaboratories.mixcr-clonotyping-2.model";
import { QcCheckDescriptions } from "@platforma-open/milaboratories.mixcr-clonotyping-2.model";
